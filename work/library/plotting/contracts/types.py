...
This module defines constrained value sets used throughout the
styling and rendering system.

These types act as strict contracts for Matplotlib-compatible
visual parameters and ensure consistency across all rendering
backends.
"""
...
ColormapLiteral: TypeAlias = Literal[
    "magma", "inferno", "plasma", "viridis", "cividis",
    "twilight", "twilight_shifted", "turbo", "berlin", "managua",
    "vanimo", "Blues", "BrBG", "BuGn", "BuPu",
    "CMRmap", "GnBu", "Greens", "Greys", "OrRd",
    "Oranges", "PRGn", "PiYG", "PuBu", "PuBuGn",
    "PuOr", "PuRd", "Purples", "RdBu", "RdGy",
    "RdPu", "RdYlBu", "RdYlGn", "Reds", "Spectral",
    "Wistia", "YlGn", "YlGnBu", "YlOrBr", "afmhot",
    "autumn", "binary", "bone", "brg", "bwr",
    ...
    "hot", "hsv", "jet", "nipy_spectral", "ocean",
    "pink", "prism", "rainbow", "seismic", "spring",
    "summer", "terrain", "winter", "Accent", "Dark2",
    "Paired", "Pastel1", "Pastel2", "Set1", "Set2",
    "Set3", "tab10", "tab20", "tab20b", "tab20c",
    "grey", "gist_grey", "gist_yerg", "Grays", "magma_r",
    "inferno_r", "plasma_r", "viridis_r", "cividis_r", "twilight_r",
    "twilight_shifted_r", "turbo_r", "berlin_r", "managua_r", "vanimo_r",
    "Blues_r", "BrBG_r", "BuGn_r", "BuPu_r", "CMRmap_r",
    "GnBu_r", "Greens_r", "Greys_r", "OrRd_r", "Oranges_r",
    "PRGn_r", "PiYG_r", "PuBu_r", "PuBuGn_r", "PuOr_r",
    "PuRd_r", "Purples_r", "RdBu_r", "RdGy_r", "RdPu_r",
    "RdYlBu_r", "RdYlGn_r", "Reds_r", "Spectral_r", "Wistia_r",
    "YlGn_r", "YlGnBu_r", "YlOrBr_r", "YlOrRd_r", "afmhot_r",
    "autumn_r", "binary_r", "bone_r", "brg_r", "bwr_r",
...
"""
Subset of supported Matplotlib colormaps.

This restricted set ensures visual consistency and avoids invalid
or deprecated colormap identifiers.
"""
